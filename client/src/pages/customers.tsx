...
export default function CustomersPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requiredFields = ['firstName', 'lastName', 'customerEmail', 'phoneNumber', 'dateOfBirth', 'idNumber', 'idType', 'houseNumber', 'line1', 'city', 'state', 'zipCode', 'idImage', 'userPhoto'];
    ...
    console.log('All fields valid, submitting to API...');
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <DialogFooter>
                ...
                <Button type="submit" disabled={createCustomer.isPending} className="bg-blue-600 hover:bg-blue-700">
